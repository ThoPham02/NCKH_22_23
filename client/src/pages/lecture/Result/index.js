...
import { data, total } from "../../common/Result/data";
    ...
    <Card title={"Đánh giá kết quả thực hiện đề tài"}>
      <Accordion defaultActiveKey="101">
        <Accordion.Item eventKey="101">
          <Accordion.Header className="add-topic-header">Đề tài của tôi</Accordion.Header>
          <Accordion.Body>
            <Accordion>
              {sortData.filter((item, index) => index < 6).map((item, index) => {
                return (
        ...
        <Accordion.Item eventKey="100">
          <Accordion.Header className="add-topic-header">Tất cả các đề tài</Accordion.Header>
          <Accordion.Body>
