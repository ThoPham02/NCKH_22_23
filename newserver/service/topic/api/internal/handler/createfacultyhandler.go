...
func CreateFacultyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateFacultyReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewCreateFacultyLogic(r.Context(), svcCtx)
		resp, err := l.CreateFaculty(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
