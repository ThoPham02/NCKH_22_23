...
func GetTopicReportsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetTopicReportsReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewGetTopicReportsLogic(r.Context(), svcCtx)
		resp, err := l.GetTopicReports(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
