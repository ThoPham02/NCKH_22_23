...
func CreateTopicMarkHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateTopicMarkReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewCreateTopicMarkLogic(r.Context(), svcCtx)
		resp, err := l.CreateTopicMark(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
