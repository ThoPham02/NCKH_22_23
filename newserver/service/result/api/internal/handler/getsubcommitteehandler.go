...
func GetSubcommitteeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetSubcommitteesReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewGetSubcommitteeLogic(r.Context(), svcCtx)
		resp, err := l.GetSubcommittee(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
